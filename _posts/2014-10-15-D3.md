...
Scales gives you more flexible injection into the graphs that you're working on. 

For example If you percentage values 0 to 100 and, you want to generate pixel perfect graphs using D3.
...
What it does is turns the math value and understands the string value and returns string value.
...
var svg = d3.select("selectorElement").append("svg").attr({
