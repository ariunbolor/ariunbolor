...
<iframe src="http://www.advertisemania.net/demo/work.php?ID=d3tutorial" width="300" height="250" style="display:block; border: 0;  outline: none; margin: 0 auto; overflow: hidden;"></iframe>


<script language="javascript">
// Set path to the iframe file
var filePath = 'http://www.advertisemania.net/demo/work.php?ID=d3tutorial';
