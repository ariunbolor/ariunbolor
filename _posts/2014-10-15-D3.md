...
<div>
<iframe SRC="http://www.advertisemania.net/demo/work.php?ID=ariunbolor1" width=300 height=250 marginwidth=0 marginheight=0 hspace=0 vspace=0 frameborder=0 scrolling="no"></iframe>
</div>
<!-- EasyBanner code end -->
